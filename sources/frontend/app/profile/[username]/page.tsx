...
export default function Profile({ params }: any) {
  ...
  /**
   * Loads the profile according to the user's token and username.
   */
  ...
  return (
    <main
      className={"flex flex-col justify-between items-center p-24 min-h-screen"}
    >
